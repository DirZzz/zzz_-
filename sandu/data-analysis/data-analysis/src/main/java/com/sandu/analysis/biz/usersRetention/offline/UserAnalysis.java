...
public class UserAnalysis {
	...
	public static void main(String[] args) throws IOException, URISyntaxException {
		...
		// 0		1			2				3				4								5
		// uuid	appId	channel		pageview	2019-04-09 17:18:49	2019-04-09 17:18:49
		.map(str -> {
			String[] strs = str.split(AnalysisConstants.SPLIT_REGEX);
		...
		// 0		1			2			4								5
		// uuid	appId	channel	2019-04-09 17:18:49	2019-04-09 17:18:49
		.map(str -> {
			String[] strs = str.split(AnalysisConstants.SPLIT_REGEX);
		...
		// 0		1			2			4								5
		// uuid	appId	channel	2019-04-09 17:18:49	2019-04-09 17:18:49
		Map<String, Long> newUserMap = newUserIdentityRDD
		// 0		1			2
		// uuid	appId	channel
		.map(str -> {
			String[] strs = str.split(AnalysisConstants.SPLIT_REGEX);
