...
public class HouseEventConstants {
	...
	public enum HouseEventFlagEnum {
		 ...
		 * 户型使用---自己装修(pc2b)
		 */
		SELF_DECORATE("serviceEvent\tselfDecorateHouseUse\tpc2b", "pcHouseUse"),
		/**
		 * 户型使用---一键装修事件(pc2b)
		 */
		ONEKEY_DECORATION("serviceEvent\tonekeyDecorationHouseUse\tpc2b", "pcHouseUse"),
		/**
		 * 户型使用---装修我家(移动端)
		 */
		DECORATE_MYHOME("serviceEvent\thouseUse\tmobile2b", "mobileHouseUse")
		;
