package com.sandu.analysis.constant;

public interface ConfigConstants {
	
	String RUN_ENV = "run.env";
	String RUN_ENV_LOCAL = "local";
	String RUN_ENV_PROD = "prod";
	...
	/*String HDFS_DIR = "hdfs.dir";*/
	String HDFS_DOMAIN = "hdfs.domain";
	String HDFS_EVENTS_DIR = "hdfs.events.dir";
	String HDFS_USERIDENTITY_DIR = "hdfs.userIdentity.dir";
	String HDFS_NEWUSERIDENTITY_DIR = "hdfs.newUserIdentity.dir";
