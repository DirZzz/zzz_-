...
public class EditPasswordController {
    ...
    public ResponseEnvelope modify2BUserMobileAndPassword(@Valid UserUpdatePasswordAndMobile userParam, BindingResult validResult) {
        ...
        try {
            ...
            return new ResponseEnvelope<>(false, null, ex.getMessage(), userParam.getMsgId(), ex.getCode());
        } catch (Exception ex) {
  ...
  //      if (1 == 1) {
            try {
                ...
                return new ResponseEnvelope<>(false, null, ex.getMessage(), userUpdateMobile.getMsgId(), ex.getCode());
            } catch (Exception ex) {
