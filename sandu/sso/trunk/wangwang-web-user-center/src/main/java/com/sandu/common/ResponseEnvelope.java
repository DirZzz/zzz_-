...
public class ResponseEnvelope<T> implements Serializable{
	...
	public ResponseEnvelope(boolean success,Object obj,String message,String msgId,Integer exceptionCode) {
		this.success=success;
		this.obj = obj;
		this.msgId = msgId;
		this.message = message;
	...
	public ResponseEnvelope(boolean success,Object obj,String message,String msgId,boolean flag) {
		this.success=success;
		this.obj = obj;
		this.msgId = msgId;
		this.message = message;
