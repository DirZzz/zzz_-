...
public interface SysUserManageService {
   ...
   List<DealersUserListVO> getDealersUserList(DealersUserQuery userQuery);
    ...
    PageInfo<UserMasterSonVO> masterSonUserList(UserMasterSonSearch userMasterSonSearch);

    PageInfo<UserMasterSonVO> companySonUserList(UserMasterSonSearch userMasterSonSearch);

    void setUpMSType(UserMSTypeSet userMSTypeSet,LoginUser loginUser);

 Map<String, String> mangeFreeze(AccountFreezeManage manage);
}
