        ...
        <div class="edit-account-content">
                ...
                <el-form ref="ruleForm" :rules="rules" :model="ruleForm" label-width="110px" >
                    ...
                    <div class="form-right">
                        ...
                        <el-form-item label="用户类型：">
                            <span>{{editInfoData.userTypeStr}}</span>
                        </el-form-item>
                        <el-form-item label="主子类型：">
                            <span>{{editInfoData.masterSonType==0 ? '普通账号' : editInfoData.masterSonType==1 ? '子账号' : '主账号'}}</span>
                        </el-form-item>
                    </div>
                    <div class="footer">
                        <el-form-item>
            ...
            <div class="datails" v-if="isDatails">
                ...
                <div class="datails-right">
                    ...
                    <div class="datails-right-item"><p>主子类型：</p><span>{{datails.masterSonType==0 ? '普通账号' : datails.masterSonType==1 ? '子账号' : '主账号'}}</span></div>
                </div>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                nav:[
                    {nav: '账号管理', url: '/business/mainAccountSet'},
