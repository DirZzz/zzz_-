            ...
            <el-row :gutter="24" class="splineFrame">
                ...
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                    <el-form-item label="店铺名称：" prop="shopName">
                        <el-input v-model="ruleForm.shopName" placeholder="请输入" class="shop-name" size="medium" maxlength="50"></el-input>
                    </el-form-item>
                    <el-form-item label="联系人姓名：" prop="contactName">
                        <el-input v-model="ruleForm.contactName" placeholder="请输入" class="contacts" size="medium" maxlength="50"></el-input>
                    </el-form-item>
                    <el-form-item label="联系人电话：" prop="contactPhone">
                        <el-input v-model="ruleForm.contactPhone" placeholder="请输入" class="contacts" size="medium" maxlength="13"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="详细地址：" prop="shopAddress">
                        <el-input v-model="ruleForm.shopAddress" placeholder="请输入" class="shop-name" size="medium" maxlength="100"></el-input>
                    </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            /*富文本上传图片*/
            handleImageAdded(file,fileName, Editor, cursorLocation, resetUploader) {
                if (!this.upload(file)) {
                    return;
                }
                ...
                this.API.upLoadImg(formData).then(res => {
                    if (res.code==200) {
                        ...
                        if (res.data.resId) {
                            this.ruleForm.introducedPicImg=[];
            ...
            getShopOfflineDetail(index){
                this.API.getShopOfflineDetail({
                    id: this.$route.params.id
                        ...
                        this.coverImgUrl=res.data.coverPicPath;
                        this.ruleForm.introduce = res.data.shopIntroduced;
                        this.logoImgUrlId = res.data.logoPicId;
                        this.coverImgUrlId = res.data.coverPicId?res.data.coverPicId.split(','):[];
                    ...
                    if (res.data.areaCode) {
                        ...
                        res.data.streetCode?this.ruleForm.streetCode = res.data.streetCode:'';
                    }
                    if (res.data.coverPicPath) {
                        let arr = [],
                            arrId = res.data.coverPicId?res.data.coverPicId.split(","):[];
                        for (let i = 0; i < res.data.coverPicPath.length; i++) {
                            arr.push(res.data.coverPicPath[i])
            ...
            submitForm(formName) {
                this.$refs[formName].validate(valid => {
                    if (valid) {
                        console.log('ggaga',this.logoImgUrlId)
                        console.log('ggassssga',this.coverImgUrlId)
                        ...
                        let obj = {
                            ...
                            shopIntroduced:  this.ruleForm.introduce==null?"":this.ruleForm.introduce.replace(/[\n\r]/g,''), //富文本
