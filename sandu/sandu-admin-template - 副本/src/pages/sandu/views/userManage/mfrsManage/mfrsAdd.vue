        ...
        <el-row :gutter="60">
          ...
          <el-col :span="12">
            <el-form-item label="所属行业:">
              <belongIndustry :linkType="true" @change="industryChange"></belongIndustry>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-form-item label="企业可见产品范围:" prop="selectTitle">
            <produceRange :title="formParam.selectTitle" @change="produceRangeChange"></produceRange>
          </el-form-item>
        </el-row>
        <el-row>
    ...
    save() {
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          ...
          if (
            this.formParam.companyDomainName &&
            !validateURL(this.formParam.companyDomainName)
          ) {
