    ...
    <div class="main">
        <div class="main-header">
            ...
            <el-row>
                ...
                <el-select v-model="selectValue" clearable placeholder="主子类型">
                    <el-option
        ...
        <userList @handleSelectionChange="handleSelectionChange" @showBatch="showBatch" :userdata="userListData" :page="page" :businessType='businessType' :loading="loading" @refresh="getlist('vendor',$route.query.id)" @pageChange="pageChange" @sizeChange="sizeChange" @pageReset="pageReset" @resetLoad="resetLoad"></userList>
         <batch v-if="batchShow"  @pwdClose="pwdClose"
                @pwdSure="pwdSure"></batch>
         <packageEdit v-if="mfrUserCnmShow" ref="packageEdit" @mealSure="mealSure"></packageEdit>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.mfrUserCnmShow=true;
        },
        deactivated() {
            console.log('離開頁面')
            this.mfrUserCnmShow=false;
        },
        methods:{
            showBatch(type) {
            ...
            mealSure(id) {
                ...
                this.API.batchModify(mark).then(res=>{
                    if (res.success) {
                        ...
                        this.getlist('vendor',this.$route.query.id)
                    } else {
