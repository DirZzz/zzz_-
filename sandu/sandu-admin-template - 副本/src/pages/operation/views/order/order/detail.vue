<template>
  <div>
    <div class="reBack">
      <b>
        <router-link to="/operation/order/order" style="color: #FF6419">返回上一级 | 订单管理列表</router-link>>
      </b> 详情
    </div>
    <div class="orderDetailMsg">
      ...
      <div class="printOrder">
        ...
        <router-link to="/operation/order/order"><el-button round>关闭</el-button></router-link>
      </div>
    </div>
  </div>
</template>
