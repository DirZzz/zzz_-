            ...
            >
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button type="text" @click="goToDetail(scope.row.buttonProperty,scope.row.currentPageProperty)">详细分析</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    ...
    export default {
        ...
        methods:{
            goToDetail(buttonProperty,currentPageProperty){
                let lastPageData = {
                ...
                sessionStorage.setItem('lastPageData',JSON.stringify(lastPageData))
                this.$router.push({path:'/dataAnalysis/elementStatistics/detail',query:{buttonProperty:buttonProperty,currentPageProperty:currentPageProperty} })
            },
            pageList(){
            ...
            exportExcel(){
                this.API.elementExportListExcel({
                    startTime:moment(this.pickTime[0]).format("YYYY-MM-DD"),
                    endTime:moment(this.pickTime[1]).format("YYYY-MM-DD"),
                    appId:this.appletType==='随选网'?'wx42e6b214e6cdaed3':'wxf1113bc672fe7112',
                    channel:this.userSource,
