    ...
    <div class="main-body">
      ...
      <el-form :inline="true" class="filterBar">
        ...
        <el-form-item label="位置">
          <el-select
            v-model="filterDatas.appointmentPosition"
            clearable
            filterable
            @change="initData"
          >
        ...
        <el-form-item label="店铺类型">
          <el-select v-model="filterDatas.shopType" clearable filterable @change="initData">
            <el-option
        ...
        <el-form-item label="跟进结果">
          <el-select v-model="filterDatas.traceResult" clearable filterable @change="initData">
            <el-option
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      this.API.exportChartLineDataByAppointment(this.filterDatas).then(data => {
        var t = new Blob([data], {
        ...
        (a.style.display = "none"),
          (a.href = n),
          a.setAttribute("download", `用户预约数据统计数据.xls`),
