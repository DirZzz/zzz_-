package com.sandu.cloud.company.model;
...
public class Company implements Serializable {
     ...
     * 是否接收平台派单(0:不接收;1:接收)
     */
    private Byte isReceivePlatformDispatch;

    /**
     * 是否接收内部推荐(0:不接收;1:接收)
     */
    private Byte isReceiveInteriorDispatch;
    ...
    /**
     * 显示logo方式(0:显示三度logo；1:显示本公司logo；2:显示第三方企业logo；3:显示厂商公司logo)
     */
    private Byte showLogoType;
