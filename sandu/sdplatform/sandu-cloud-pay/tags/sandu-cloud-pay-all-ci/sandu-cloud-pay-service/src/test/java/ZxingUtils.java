...
public class ZxingUtils {
	...
	public static File getQRCodeImge(String contents, int width, int height, String imgPath) {
		try {
            ...
            String url=imgPath.substring(0, imgPath.indexOf(imageFile.getName()));
            File f = new File(url);
            if(!f.exists()){
            	f.mkdirs();
            }
	...
	public static void main(String[] args) {
		...
		ZxingUtils.getQRCodeImge("https://qr.alipay.com/bax01478rmcmklbsyzkb60e7", 256, "d://code1.png");
		//ZxingUtils.getQRCodeImge("https://qr.alipay.com/bax04170puxytqll4een40bf", 256, "d://code.png");
	}
}
