...
public class AESTool {
    ...
    public AESTool(String mchKey) {
    	...
    	key = new SecretKeySpec(DigestUtils.md5Hex(mchKey).toLowerCase().getBytes(), ALGORITHM);
    }
    ...
    public static void main(String[] args) throws Exception {
       ...
       // System.out.println(new AESTool("wxb3048NorKad782765143df7NorKcb2").encryptData(A));
