...
public interface ProductService {
    ...
    void mergeProducts(ProductMerge productMerge, Long id);

    void updateProductMergeFlag(Integer preMainId, Integer mergeFlag, Long userId);

    boolean checkMergeData(List<Integer> productIds);

    Integer getProductMergeFlagByProductId(long productId);

    List<MergeProductBO> getMergeProductsByMainProductId(Long id);

    int modifyProductDecorationPrice(String productCode,String decorationPrice,Integer userId);
}
