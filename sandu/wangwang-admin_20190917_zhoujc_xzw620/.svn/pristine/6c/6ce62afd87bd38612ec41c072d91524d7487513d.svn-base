...
public interface ResTextureDao {
     ...
     * 批量公开/取消公开材质
     * @param idList 材质id集合
     * @param secrecyFlag 是否公开
     * @param modifier 修改人
     * @return:int
     */
    int updateSecrecyFlagByIdList(@Param("idList")List<Integer> idList,@Param("secrecyFlag")Integer secrecyFlag,@Param("modifier")String modifier);
}
