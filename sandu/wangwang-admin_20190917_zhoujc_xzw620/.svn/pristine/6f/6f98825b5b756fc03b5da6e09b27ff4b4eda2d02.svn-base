...
//    @NotEmpty(message = "小类编码不能为空")
    ...
    @ApiModelProperty("床沿尺寸")
    @Size(max = 9, message = "请输入正确的床沿尺寸")
    private String bedsideDimensions;

    @ApiModelProperty("装修单价")
    @Size(max = 9, message = "请输入正确的装修单价")
    ...
    @ApiModelProperty("是否有特效，0：否，1：是")
