...
//                .fileCode(formatCode("C", resTextureDao.getMaxId()))
                ...
                .classification(resTextureAdd.getClassification())
                .colorSystem(resTextureAdd.getColorSystem())
                .build();
    ...
    public Long saveResTexture(ResTextureUpdate resTextureUpdate) {
        ResTexture resTexture = ResTexture
                ...
                .classification(resTextureUpdate.getClassification())
                .colorSystem(resTextureUpdate.getColorSystem())
                .build();
        resTextureDao.saveResTexture(resTexture);
        return resTexture.getId();
    }
...
//                .picHigh(String.valueOf(image.getHeight()))
    ...
    @Override
    public void batchUpdateSecrecyFlag(List<Integer> textureIdList, Integer operationType,String modifier) {
        resTextureDao.updateSecrecyFlagByIdList(textureIdList,operationType,modifier);
    }
}
