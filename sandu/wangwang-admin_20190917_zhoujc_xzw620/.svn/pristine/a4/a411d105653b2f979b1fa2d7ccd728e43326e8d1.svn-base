...
public interface CompanyDao {
    ...
    List<RichContext> findAllCompanyRichContext();

    List<Company> findByIds(@Param("ids") List<Long> companyIds);

    void updateBatch(@Param("updateList") List<Company> updateList);

    Long findConpanyIdByAppId(@Param("appId") String appId);
}
