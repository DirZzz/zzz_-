...
public interface ProductDao {
    ...
    void updateProductOptionalParam(Product product);

    void mergeProducts(@Param("productMerge") ProductMerge productMerge, @Param("userId") Long id);

    void updateProductMergeFlag(@Param("mainProductId") Integer mainProductId, @Param("mergeFlag") Integer mergeFlag, @Param("userId") Long userId);

    int checkMergeDate(@Param("productIds") List<Integer> productIds);

    Integer getProductMergeFlagByProductId(@Param("productId") long productId);

    List<MergeProductBO> getMergeProductsByMainProductId(@Param("id") Long id);

    int updateProductDecorationPrice(@Param("productCode") String productCode, @Param("decorationPrice") String decorationPrice);

    void insertProductOperationRecord(ProductOperationRecord record);

    int saveProductExtension(ProductExtension productExtension);

    void updateProductExtension(ProductExtension productExtension);

    ProductExtension getProductExtensionByProductId(@Param("productId") long ProductId);
