...
public class CompanyServiceImpl implements CompanyService {
    ...
    @Override
    public List<RichContext> findAllCompanyRichContext() {
        return companyDao.findAllCompanyRichContext();
    }

    @Override
    public List<Company> findByIds(List<Long> companyIds) {
        return companyDao.findByIds(companyIds);
    }

    @Override
    public void updateBatch(List<Company> updateList) {
        companyDao.updateBatch(updateList);
    }

    @Override
    public Long findConpanyIdByAppId(String appId) {
        return companyDao.findConpanyIdByAppId(appId);
    }
}
