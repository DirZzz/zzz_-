...
public class DesignPlanBO implements Serializable {
    ...
    @ApiModelProperty(value = "运营管理 > 首页展示")
    ...
    @ApiModelProperty(value = "是否被全屋方案使用次数")
    private Integer usedInFullPlanCount;

    @ApiModelProperty(value = "适用面积")
    private List<String> applyAreaNames;

    @ApiModelProperty(value = "适用面积-dpr.apply_space_areas")
    private String applySpaceAreas;

    @ApiModelProperty(value = "空间类型valueKey")
    private String spaceTypeValueKey;
    @JsonIgnore
    private String isShowCoverPicIds;
    
    /**
     * coverPicStatus = 0: 没有设置封面图
     * coverPicStatus = 1: 已设置封面
     */
    private Integer coverPicStatus;

    private Integer customizeVideoFileId;
    private String customizeVideoFilePath;

    public interface coverPicStatusConstants {
    	
    	Integer NO_COVER_PIC = 0;
    	
    	Integer HAS_COVER_PIC = 1;
