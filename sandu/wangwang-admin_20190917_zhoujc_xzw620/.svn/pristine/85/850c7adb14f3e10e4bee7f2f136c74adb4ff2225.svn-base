...
public interface DesignPlanBizService {
     ...
     * @return
     */
    PageInfo<DesignPlanBO> getDesignPlanlistByIds(List<Integer> planIds);
...
//    List<Integer> deliverBatch(DesignPlanDeliveryPO designPlanDelivery);
     ...
     * @return
     */
    boolean editPlanForManager(ManagerSXWPlanUpdate update);

    List<DesignerUserKVDto> queryDesignerListByCompanyId(Integer companyId, Integer recommendedType);
}
