...
public interface DictionaryService {
    ...
    Dictionary getSmallProductTypeByValue(Integer prodcutTypeValue, Integer productSmallTypeValue);
    ...
    List<Dictionary> getUserTypeList(String type);

    List<Dictionary> listApplySpaceAreas();

    /**
     * copy from {@link DictionaryService#getUserTypeList}
     * 
     * @author huangsongbo 2019.09.02
     * @param query
     * @return
     */
	List<Dictionary> getUserTypeList(SysDictionaryQuery query);
