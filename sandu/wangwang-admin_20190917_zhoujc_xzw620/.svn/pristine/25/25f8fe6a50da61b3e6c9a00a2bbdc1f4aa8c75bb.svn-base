...
public class CompanyShopServiceImpl implements CompanyShopService {
	...
	@Override
	public List<CompanyShop> listCompanyByPlanId(Integer planId,Integer planType) {
		return companyShopDao.listCompanyShopByPlanId(planId,planType);
	}

	@Override
	public List<CompanyShopListBO> findAll() {
		return companyShopDao.selectAllList();
	}

	@Override
	public int totalShopPlan(Integer shopId) {
		return companyShopDao.countShopPlan(shopId);
	}

	@Override
	public int totalProjectCase(Integer shopId) {
		return companyShopDao.countProjectCase(shopId);
	}

	@Override
	public int totalShopArticle(Integer id) {
		return companyShopDao.totalShopArticle(id);
	}

	@Override
	public void updateBatch(List<CompanyShopListBO> updateList) {
		companyShopDao.updateBatch(updateList);
	}
}
