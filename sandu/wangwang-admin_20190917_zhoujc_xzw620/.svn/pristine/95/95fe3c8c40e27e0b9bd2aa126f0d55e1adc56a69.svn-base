...
//        deleteDbInfo(resIds,type);
    ...
    @GetMapping("test")
    public Object testFunc(Integer nodeId, Integer detailsType) {
        Integer countByNodeIdAndDetailType = cacheService.getCountByNodeIdAndDetailType(nodeId, detailsType);
        return countByNodeIdAndDetailType;
    }
