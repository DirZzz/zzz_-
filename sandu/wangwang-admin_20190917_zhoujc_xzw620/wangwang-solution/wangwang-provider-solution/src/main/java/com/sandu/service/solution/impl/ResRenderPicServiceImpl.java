...
public class ResRenderPicServiceImpl implements ResRenderPicService {
    ...
    @Override
    public List<ResRenderPic> batchFindPhotoLevelPicByRecommendedId(List<Integer> groupPlanIds) {
        return resRenderPicMapper.batchFindPhotoLevelPicByRecommendedIdAndRenderType(groupPlanIds,"design.designPlanRecommended.render.small.pic",1);
    }
}
