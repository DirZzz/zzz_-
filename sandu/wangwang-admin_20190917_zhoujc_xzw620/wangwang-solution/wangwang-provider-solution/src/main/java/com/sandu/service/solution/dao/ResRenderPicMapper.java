...
public interface ResRenderPicMapper {
    ...
    List<ResRenderPic> batchFindPhotoLevelPicByRecommendedIdAndRenderType(@Param("groupPlanIds")List<Integer> groupPlanIds, @Param("fileKey") String fileKey,@Param("renderingType") Integer renderingType);
}