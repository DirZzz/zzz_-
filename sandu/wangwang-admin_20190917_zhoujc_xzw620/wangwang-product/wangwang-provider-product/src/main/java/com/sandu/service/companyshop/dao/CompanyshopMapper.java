...
public interface CompanyshopMapper {
    ...
    int updateEnableScore(@Param("enableScore") Integer enableScore, @Param("handScore") Double handScore, @Param("shopId") Integer shopId);

    List<String> selectCompanyShopAreaInfo(@Param("areaCodeList") List<String> codeList);
}
