...
public interface CategoryDao {
    ...
    Integer getIdByNameOrFourCode(@Param("name") String name, @Param("fourthStageCode") String fourthStageCode);

    Category getCategoryByCodeOrLevel(@Param("code") String code, @Param("level") int level);
