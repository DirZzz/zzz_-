...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public Integer getIdByNameOrFourCode(String name, String fourthStageCode) {
        if (StringUtils.isEmpty(fourthStageCode) || StringUtils.isEmpty(name)) {
            return null;
        }
        return categoryDao.getIdByNameOrFourCode(name, fourthStageCode);
    }

    @Override
    public Category getCategoryByCodeOrLevel(String code, int level) {
        if (StringUtils.isEmpty(code)) {
            return null;
        }
        return categoryDao.getCategoryByCodeOrLevel(code, level);
    }
}
