...
public class DictionaryServiceImpl implements DictionaryService {
    ...
    @Override
    public Dictionary getSmallProductTypeByValue(Integer prodcutTypeValue, Integer productSmallTypeValue){
        return dictionaryDao.getSmallProductTypeByValue(prodcutTypeValue,productSmallTypeValue);
    }
...
//                });
    ...
    @Override
    public List<Dictionary> getUserTypeList(String type){
        return dictionaryDao.getUserTypeList(type);
    }

    @Override
    public List<Dictionary> listApplySpaceAreas() {
        return dictionaryDao.listApplySpaceAreas();
    }

	@Override
	public List<Dictionary> getUserTypeList(SysDictionaryQuery query) {
		return dictionaryDao.selectDictionaryByQuery(query);
	}
