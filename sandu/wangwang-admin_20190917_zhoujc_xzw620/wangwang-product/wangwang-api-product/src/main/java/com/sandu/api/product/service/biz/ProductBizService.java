...
public interface ProductBizService {
	...
	void processSplitTexturesInfo(List<Product> productList);

    Integer syncProductInfoToGoods(List<Integer> productIds, Long userId);

    void mergeProducts(ProductMerge productMerge);
}
