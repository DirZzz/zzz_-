...
public class MetaDataServiceImpl implements MetaDataService {
    ...
    @Override
    public GroupProductPo getGroupProductById(Integer groupId) {
        return metaDataDao.getGroupProductById(groupId);
    }
    ...
    @Override
    public Integer getSpaceTypeByUniqueId(String uniqueId) {
        return metaDataDao.getSpaceTypeByUniqueId(uniqueId);
    }
	
    @Override
    public int getAttributeCountByPropsCode(String attributeKey) {
        return metaDataDao.getAttributeCountByPropsCode(attributeKey);
    }

    @Override
    public Integer getSpaceAreasByPlanId(Integer planId, Integer designPlanType) {
        return metaDataDao.selectSpaceAreasByPlanId(planId, designPlanType);
    }

    @Override
    public Map<Integer, ActivityVO> getGroupPurchaseActivityBySpuIds(List<Integer> spuIds) {
        if (CollectionUtils.isEmpty(spuIds)) {
            return Collections.emptyMap();
        }
        List<ActivityVO> list = metaDataDao.getGroupPurchaseActivityBySpuIds(spuIds);
        return list.stream().collect(Collectors.toMap(ActivityVO::getActivityId, it -> it, (c, n) -> c));
    }
