...
public interface RecommendationPlanSearchService {
    ...
    SearchObjectResponse getTopDesignPlanRecommendInfo(RecommendationPlanSearchVo recommendationPlanVo);

    List<RecommendationPlanVo> dispostRecommendPlanResultList(List<RecommendationPlanIndexMappingData> recommendationPlanIndexMappingDataList, Integer userId, String platformCode, Integer companyId, String cityCode);

    void setFullPlanRenderState(Integer houseId, String authorization, List<RecommendationPlanVo> recommendationPlanVoList);
}
