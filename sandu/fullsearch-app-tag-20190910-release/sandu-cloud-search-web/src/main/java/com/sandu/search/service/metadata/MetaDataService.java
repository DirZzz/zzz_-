...
//   List<BaseCompanyMiniProgramConfig> queryBaseCompanyMiniProgramConfig() throws MetaDataException;
     ...
     * @return
     */
    GroupProductPo getGroupProductById(Integer groupId);
    ...
    int getAttributeCountByPropsCode(String attributeKey);
     ...
     * @return
     */
    Integer getSpaceAreasByPlanId(Integer planId, Integer designPlanType);

    Map<Integer, ActivityVO> getGroupPurchaseActivityBySpuIds(List<Integer> spuIds);
}
