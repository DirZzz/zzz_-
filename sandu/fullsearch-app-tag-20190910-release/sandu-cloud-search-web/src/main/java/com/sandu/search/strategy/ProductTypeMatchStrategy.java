        ...
        switch (productTypeValue) {
            ...
            case ProductTypeValue.PRODUCT_TYPE_VALUE_WALL:
                ...
                switch (productTypeSmallValue) {
                    ...
                    //墙板
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_WALLBOARD_WALL:
                    //墙面_原墙面(墙体)
                    ...
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_ORIGIN_BELT_COURSE_WALL:
                        ...
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_WALLBOARD_WALL);
            ...
            case ProductTypeValue.PRODUCT_TYPE_VALUE_ACCESSORIES:
                switch(productTypeSmallValue){
                    ...
                    // 鞋子
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_SHOES_ACCESSORIES:
                    // 箱包
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_LUGGAGE_ACCESSORIES:
                    // 首饰
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_JEWELRY_ACCESSORIES:
                    // 化妆品
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_COSMETICS_ACCESSORIES:
                    // 玩具
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_TOYS_ACCESSORIES:
                    // 公仔
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_DOLL_ACCESSORIES:
                    // 坐垫
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_CUSHION_ACCESSORIES:
                    // 餐具
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_TABLEWARE_ACCESSORIES:
                    // 原餐具
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_ORIGIN_TABLEWARE_ACCESSORIES:
                    // 服装
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_CLOTHING_ACCESSORIES:
                        // 摆件-花艺-生活用品-书籍-鞋子-箱包-首饰-化妆品-玩具-公仔-坐垫-服装-餐具-其他
                        ...
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_SHOES_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_LUGGAGE_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_JEWELRY_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_COSMETICS_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_TOYS_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_DOLL_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_CUSHION_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_CLOTHING_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_TABLEWARE_ACCESSORIES);
                    ...
                    case ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_ORIGIN_OTHER_ACCESSORIES:
                        // 摆件-花艺-生活用品-书籍-鞋子-箱包-首饰-化妆品-玩具-公仔-坐垫-服装-餐具-镜子-挂件-装饰画-创作画-其他
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_SMALL_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_FLOWER_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_LIFE_ACCESSORIES);
                        productSmallTypeList.add(ProductSmallTypeValue.PRODUCT_SMALL_TYPE_VALUE_BOOK_ACCESSORIES);
