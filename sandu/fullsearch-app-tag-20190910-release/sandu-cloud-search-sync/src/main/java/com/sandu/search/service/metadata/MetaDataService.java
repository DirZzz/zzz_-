...
public interface MetaDataService {
    ...
    List<BaseProductDataPo> queryBaseProductData(int start, int limit) throws MetaDataException;
     ...
     * @throws MetaDataException
     */
    List<ProductGroupDetailPo> queryProductGroupDetail() throws MetaDataException;
     ...
     * @throws MetaDataException
     */
    List<UsedProductsPo> queryLastMonthUsedProductData(String startTime, String endTime) throws MetaDataException;
     ...
     * @return
     */
    List<GroupPlatformRelPo> queryAllPlatformGroupMetaData() throws MetaDataException;

    List<Integer> selectLivingIds(int start, int limit);

    List<CompanyShopPo> companyId2CompanyBrandShopId();
}
