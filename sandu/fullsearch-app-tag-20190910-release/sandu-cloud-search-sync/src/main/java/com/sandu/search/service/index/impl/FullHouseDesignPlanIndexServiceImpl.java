...
import com.sandu.search.entity.elasticsearch.po.metadate.PlanQuotedPricePO;
...
public class FullHouseDesignPlanIndexServiceImpl implements FullHouseDesignPlanIndexService {
    ...
    @Override
    public List<PlanQuotedPricePO> queryFullHouseQuotedPriceByIds(List<Integer> fullHouseIds) {
        if (fullHouseIds == null || fullHouseIds.isEmpty()) {
            return Collections.emptyList();
        }
        return fullHouseDesignPlanIndexDao.queryFullHouseQuotedPriceByIds(fullHouseIds);
    }
}
