...
public class ElasticSearchConfig {
    ...
    //是否索引组合产品数据
    private boolean indexGroupProductData;
    //是否初始化户型索引
    private boolean initHouseIndex;
    private boolean initLivingIndex;
    //Whether is recreated the new index that use the new index name, This is required the indexProductData is true.
    //ex:product_info_20180728
    private String reIndexProductDataIndexName;
    private String reIndexGoodsDataIndexName;
    private String recommendedPlanDataIndexName;
    private String groupProductDataIndexName;
    private String livingDataIndexName;
    //是否索引商品数据
    private boolean initGoodsData;
