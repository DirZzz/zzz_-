...
public interface DesignPlanIndexService {
    ...
    UpdateResponse updatePlanLikeAndCollectAndCommentOfNumInfo(String id, Integer likeNum, Integer collectNum, Integer commentsNum);

    List<PlanQuotedPricePO> queryDesignPlanQuotedPriceByIds(List<Integer> planIds);
}
