...
public class QueryConditionField {
    ...
    //产品1级分类名
    public final static String QUERY_CONDITION_FIELD_PRODUCT_FIRSTLEVEL_CATEGORYNAME = "firstLevelCategoryName";
    //产品二级分类名
    ...
    //当前时间前一个月的产品使用次数
    public final static String QUERY_CONDITION_FIELD_LASTMONTH_USEDPRODUCT_COUNT = "lastMonthProductUsageCount";
    //数据是否被删除
    ...
    //平台发布状态-随选网
    public final static String QUERY_CONDITION_FIELD_PRODUCT_PLATFORM_SELECT_DECORATION_PUTAWAT_STATUS = "platformProductSelectDecoration";
    //产品保密标识
    ...
    //一石多面
    public final static String QUERY_CONDITION_FIELD_IS_COMPLEX_PARQUET = "isComplexParquet";

    public final static String QUERY_CONDITION_FIELD_PRODUCT_STYLE_IDS = "productStyleIds";
    ...
    //方案企业装修报价（集合）
    public final static String QUERY_CONDITION_FIELD_RECOMMENDATION_PLAN_QUOTED_PRICE_LIST = "planQuotedPriceList";
    public final static String QUERY_CONDITION_FIELD_RECOMMENDATION_PLAN_QUOTED_PRICE_LIST_PRICE = "price";
    public final static String QUERY_CONDITION_FIELD_RECOMMENDATION_PLAN_QUOTED_PRICE_LIST_CITY_CODE = "cityCode";
    //店铺ID
    public final static String QUERY_CONDITION_FIELD_RECOMMENDATION_PLANA_SHOP_ID = "shopId";
    //方案ID
    public final static String QUERY_CONDITION_FIELD_RECOMMENDATION_PLANA_PLAN_ID = "planId";
    //方案店铺平台
    ...
    public final static String QUERY_CONDITION_FIELD_SORT = "sort";

    // 方案是否在随选网展示
    public final static String QUERY_CONDITION_FIELD_SHOW_IN_SXW_FLAG = "showInSXWFlag";
    public final static String QUERY_CONDITION_FIELD_PLAN_QUOTED_PRICE = "planQuotedPrice";

    /********************************** 组合产品 ***************************************/

    //组合id
    public final static String QUERY_CONDITION_FIELD_GROUP_ID = "id";
    //组合编码
    public final static String QUERY_CONDITION_FIELD_GROUP_CODE = "groupCode";
    //组合名称
    public final static String QUERY_CONDITION_FIELD_GROUP_NAME = "groupName";
    //产品分类编码
    public final static String QUERY_CONDITION_FIELD_PRODUCT_CATEGORY_CODE = "categoryCode";
    //产品分类长编码
    public final static String QUERY_CONDITION_FIELD_PRODUCT_CATEGORY_LONG_CODE = "categoryLongCode";
    //产品小类
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_SMALL_TYPE_VALUE = "productSmallTypeValue";
    //组合用户
    public final static String QUERY_CONDITION_FIELD_MY_GROUP_USER_ID = "userId";
    //组合状态
    public final static String QUERY_CONDITION_FIELD_GROUP_STATE = "state";
    //组合分类
    public final static String QUERY_CONDITION_FIELD_GROUP_COMPOSITE_TYPE = "compositeType";
    //组合类型
    public final static String QUERY_CONDITION_FIELD_GROUP_TYPE = "groupType";
    //品牌ID
    public final static String QUERY_CONDITION_FIELD_BRAND_ID = "brandId";
    //品牌名称
    public final static String QUERY_CONDITION_FIELD_BRAND_NAME = "brandName";
    //组合面积
    public final static String QUERY_CONDITION_FIELD_GROUP_SPACE_AREAS = "spaceAreaValue";
    //组合修改时间
    public final static String QUERY_CONDITION_FIELD_GROUP_GMT_MODIFIED = "gmtModified";
    //数据是否被删除
    public final static String QUERY_CONDITION_FIELD_GROUP_PRODUCT_IS_DELETEd = "dataIsDeleted";
