...
public class ProductIndexMappingData implements Serializable {
    ...
    //产品全铺高度(白膜)
    private Integer productFullPaveHeight;
    ...
    //随选网
    private ProductPlatformRelPo platformProductSelectDecoration;
    ...
    //上个月产品使用数量
    private Integer lastMonthProductUsageCount;
}