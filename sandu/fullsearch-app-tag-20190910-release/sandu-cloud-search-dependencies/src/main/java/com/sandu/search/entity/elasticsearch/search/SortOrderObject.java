...
public class SortOrderObject implements Serializable {
    ...
    public static final String TRACK_SCORES = "trackScores"; //分数强制排序
    ...
    public SortOrderObject(ScoreSortBuilder scoreSort, String sortType) {
    ...
    //分数排序
    private ScoreSortBuilder scoreSort;
