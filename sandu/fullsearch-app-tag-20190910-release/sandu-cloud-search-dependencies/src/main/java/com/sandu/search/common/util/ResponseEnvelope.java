...
public class ResponseEnvelope<T> implements Serializable {
    ...
    public ResponseEnvelope(boolean success, boolean status, String message, Object obj, long totalCount, String statusCode, String msgId, List<T> datalist, boolean flag) {
