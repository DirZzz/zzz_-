 ...
 */
@Data
@ToString(exclude = {"matchQueryList"})
public class ProductSearchMatchVo implements Serializable {
    ...
    private List<QueryBuilder> matchQueryList;
    // 或匹配
    private List<MultiMatchField> shouldMatchSearchList;
    // 通配符匹配
    private List<MultiWildcardQuery> wildcardMatchSearchList;
    ...
    //当前搜索白膜大类
    private Integer nowProductTypeValue;
    ...
    //是否有产品库权限
    private boolean productLibraryAuth = false;
    //排序字段
     ...
     * 白膜全铺高度
     */
    private Integer fullPaveHeight;
    ...
    /**
     * 保密标识(true：只能搜索公开产品， false: 都可以搜索出来)
     */
    private boolean secrecyFlag = true;
