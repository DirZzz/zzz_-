...
public class RecommendationPlanSearchVo implements Serializable {
    ...
    private List<Integer> excludeFullHouseIds;

    private Integer showInSXWFlag;
    private Integer planQuotedPriceLowest;
    private Integer planQuotedPriceHighest;
    private String cityCode;
    //空间的uniqueId，用来查询空间类型
