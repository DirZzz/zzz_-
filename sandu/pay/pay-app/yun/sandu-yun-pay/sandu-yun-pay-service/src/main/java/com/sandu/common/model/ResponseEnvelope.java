...
public class ResponseEnvelope<T> implements Serializable {
    ...
    public ResponseEnvelope(boolean success, String message, String msgId, boolean status) {
        this.success = success;
        this.message = message;
        this.msgId = msgId;
        this.status = status;
    ...
    public ResponseEnvelope(boolean success, String message,boolean flag,String statusCode, boolean status) {
        this.success = success;
        this.message = message;
